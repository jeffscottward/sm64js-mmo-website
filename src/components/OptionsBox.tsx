          ...
          <div id="colorCodePasteWindow">
            ...
            <div>
              <button
                className="blue-button"
                onClick={() => {
                  window.myMario.skinData = window.parseColorCode($('#ccPasteArea').value)
                  $('#ccPasteArea').value = ''
